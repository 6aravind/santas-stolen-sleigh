...
# Starting solution based randomness and capacity
def initial_sol():
    Trips = []
...
# find neighbour solutions for AssignTrip
...
# Calling the annealing method to assign gifts to trips
...
# Compute haversine distance using numpy
...
# Compute Weighted Reindeer Weariness
...
# Order the gifts for Trip using annealing for better score
...
# Run SA for every trip and append results
...
all_trips = Sub.merge(Data, on='GiftId')
